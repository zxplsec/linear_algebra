...
\tikzset{
    node style sp/.style={draw,thick,circle,minimum size=\myunit},
    node style ge/.style={circle,very thick,minimum size=\myunit},
    arrow style mul/.style={draw,thick,sloped,midway,fill=white},
    arrow style plus/.style={midway,thick,sloped,fill=white},
}
